...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><h3 style="color:blue;font-weight: bold;">Gestor Historias de Usuario</h3></a>
    </div>
    ...
    <div class="register-box-body">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> Acepta terminos y <a href="#">condiciones</a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ url('/login') }}" class="text-center">Actualmente poseo una cuenta</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
